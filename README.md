...
* **Interação Dinâmica no Chat:** Sistema inteligente para salvar skins na sua biblioteca local através de botões no chat (`[SIM]` / `[NAO]`), com numeração automática para evitar sobreposição (ex: `nick_2.png`).
...
3. Inicie o jogo usando o perfil do Forge 1.8.9.
4. Dentro do jogo, utilize o comando (ex: `/skinmanager`) para abrir a interface.
